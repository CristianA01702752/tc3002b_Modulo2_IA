...
dense_layer1 = layers.Dense(256, activation='relu')(global_avg_pooling)
output_layer = layers.Dense(13, activation='softmax')(dense_layer1) 
...
model.save('Food_Classification.keras')